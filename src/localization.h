...
struct Localization{
    ...
    void localization(){
        ...
        double angle1=corner.0.i*scan.angle_increment;
        double angle2=corner.1.i*scan.angle_increment;
        double angle3=corner.2.i*scan.angle_increment;
        double angle4=corner.3.i*scan.angle_increment;
